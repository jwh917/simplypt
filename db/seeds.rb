...
pt1 = PhysicalTherapist.create(username: "K0530", password_digest: "KWH", name: "Ken", email: "kwh@simplypt.org", type: "PhysicalTherapist", image: "http://s3.amazonaws.com/pix.iemoji.com/images/emoji/apple/ios-12/256/man-medium-light-skin-tone.png")
pt2 = PhysicalTherapist.create(username: "J0926", password_digest: "JACH", name: "Janet", email: "jach@simplypt.org", type: "PhysicalTherapist", image: "http://s3.amazonaws.com/pix.iemoji.com/images/emoji/apple/ios-12/256/woman-curly-haired-medium-skin-tone.png")

pt3 = PhysicalTherapist.create(username: "K1005", password_digest: "KAT", name: "Kathy", email: "kathy@simplypt.org", type: "PhysicalTherapist", image: "http://s3.amazonaws.com/pix.iemoji.com/images/emoji/apple/ios-12/256/woman-light-skin-tone.png")
pt4 = PhysicalTherapist.create(username: "M0421", password_digest: "MAR", name: "Mark", email: "mark@simplypt.org", type: "PhysicalTherapist", image: "http://s3.amazonaws.com/pix.iemoji.com/images/emoji/apple/ios-12/256/man-dark-skin-tone.png")
